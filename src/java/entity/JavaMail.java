...
public class JavaMail {
    ...
    public static void sendall( String sub,
            String msg, final String user, final String pass) throws Exception {
        //create an instance of Properties Class   
        Properties props = new Properties();
        ...
        List<Buyer> listbu = iManageCustomer.getBuyerBySellerId(2);
            ...
            message.addRecipients(Message.RecipientType.TO, listbu.get(i).getGmail());
            }
            message.setSubject(sub);
            message.setContent(msg, "text/html");
